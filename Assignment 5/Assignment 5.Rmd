...
A naïve estimation of the relationship between education and income using ordinary least squares (OLS) would involve regressing income directly on college attainment:
...
*Conclusion:*
Using a credible instrument — randomized scholarship values — we estimate that obtaining a college degree causally increases income by between 15,000 and 21,000 dollars per year for marginal students. These results are statistically significant and robust to the inclusion of important controls.
