...
#Already done, move answer 1 here, est-ce qu'on veut bouger la data cleaning et analysis ici ?
...
To test whether income_parents is correlated with travel_time, we regress travel_time on income_parents. The null hypothesis  H_0 states that there is no correlation (α_1=0), while the alternative H_1 states that α_1 ≠ 0.
...
$$
The null hypothesis $\textttt{H}_o : \alpha_1 = 0 $ implies no correlation. The alternative hypothesis $\textttt{H}_1 : \alpha_1 \neq 0$ implies a correlation exists.
